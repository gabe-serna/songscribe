export const infoList = [
  ...
  "If you want the MIDI output to be more like static chords, increase the minimum note length and note segmentation and decrease the confidence threshold.",
